Profile: EdshObservationAlcoholUseStatus
Parent: Observation
Id: edsh-observation-alcohol-use-status
...
* code MS
* code = $loinc#11331-6 "History of Alcohol use" (exactly)
...
* performer only Reference($fr-core-practitioner or $fr-core-organization or EdshPatient or PractitionerRole or CareTeam or RelatedPerson)
* performer MS
...
* target[0] = Reference(EdshObservationAlcoholUseStatus)
