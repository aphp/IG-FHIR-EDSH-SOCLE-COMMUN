Profile: EdshObservationExerciceStatus
Parent: Observation
Id: edsh-observation-exercice-status
...
* code MS
* code from EdshExerciceStatusType (extensible)
...
* target[0] = Reference(EdshObservationExerciceStatus)
