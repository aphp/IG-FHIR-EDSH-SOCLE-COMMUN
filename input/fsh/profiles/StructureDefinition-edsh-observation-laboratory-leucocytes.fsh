Profile: EdshObservationLaboratoryLeucocytes
Parent: EdshObservationLaboratoryGeneric
Id: edsh-observation-laboratory-leucocytes
Title: "Leucocytes"
Description: """
...
* value[x] ^short = "Leucocytes — valeur mesurée, en 10*3/uL"
...
* target[0] = Reference(EdshObservationLaboratoryLeucocytes)
