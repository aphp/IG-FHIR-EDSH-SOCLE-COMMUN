Profile: EdshObservationLaboratoryBilirubineTotale
Parent: EdshObservationLaboratoryGeneric
Id: edsh-observation-laboratory-bilirubine-totale
...
* target[0] = Reference(EdshObservationLaboratoryBilirubineTotale)
