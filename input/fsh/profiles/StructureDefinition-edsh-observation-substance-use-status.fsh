Profile: EdshObservationSubstanceUseStatus
Parent: Observation
Id: edsh-observation-substance-use-status
...
* performer only Reference(EdshOrganization or EdshPatient or EdshPractitioner or EdshPractitionerRole or CareTeam or RelatedPerson)
* performer MS
...
* target[0] = Reference(EdshObservationSubstanceUseStatus)
